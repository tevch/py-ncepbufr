...
'HRDR': 'PROFILE LVL TIME-CYCLE (FOR RAOB/PIBAL, BASED ON B DFT)',\
...
'XDR': 'PROFILE LEVEL LON (FOR RAOB/PIBAL BASED ON BALLOON DFT)',\
...
'TDO': 'DEWPOINT TEMPERATURE OBSERVATION (NOT ASSIMILATED)',\
'YDR': 'PROFILE LEVEL LAT (FOR RAOB/PIBAL BASED ON BALLOON DFT)',\
