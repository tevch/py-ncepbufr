...
type sparr
   ...
   real(8), dimension(:), allocatable    :: val  ! values of non-zero elements
   integer, dimension(:), allocatable :: ind  ! indices of non-zero elements
end type sparr
...
type sparr2
   ...
   integer, dimension(:), allocatable :: st_ind      ! start indices for dense subarrays
   integer, dimension(:), allocatable :: end_ind     ! end indices for dense subarrays
   real(8), dimension(:), allocatable    :: val         ! values of non-zero elements
end type sparr2
...
subroutine sparr2_to_sparr(this, sp2)
  ...
  integer :: inz, nnz
  integer :: i, j
  real(8), dimension(:), allocatable    :: nzval  ! values of non-zero elements
  integer, dimension(:), allocatable :: nzind  ! indices of non-zero elements
